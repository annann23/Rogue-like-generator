...
2. 순수하게 좋은 결과(good)는 전체의 30% 이하로 제한
   → 이번 런 행운 여부: ${parseInt(randomSeed, 36) % 10 === 0 ? '행운 런 — 반드시 "good" 1개 포함' : '일반 런 — "good" 없이 bad / mixed / curse 만 사용'}
3. 행운 런이 아닌 경우 curseOrBlessing에 "good"을 절대 사용하지 말 것
