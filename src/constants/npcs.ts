...
export const NPC_TEMPLATES: NPCTemplate[] = [
  {
    ...
    name: '대장장이 이고르',
    icon: '🔨',
    personality: '드워프 장인 정령. 영혼의 결을 금속처럼 감별하는 고대 존재. 과묵하고 실용적이며 품질을 중시한다. 말이 적지만 신뢰할 수 있다. 친밀도가 높아지기 전까지는 자신이 정령임을 절대 드러내지 않고 평범한 장인처럼 행동한다.',
  ...
  },
  {
    ...
    name: '상인 베라',
    icon: '💰',
    personality: '영혼의 눈을 가진 행운의 상인 반신. 수다스럽고 이익을 추구하지만 정직하다. 소문을 많이 알고 있다. 친밀도가 높아지기 전까지는 자신이 반신임을 절대 드러내지 않고 평범한 상인처럼 행동한다.',
  ...
  },
  {
    ...
    name: '마법사 엘릭',
    icon: '🧙',
    personality: '불멸의 현자 반신. 영혼의 파동을 감지하는 오만하고 신비로운 존재. 지식을 과시하며 가끔 유용한 정보를 흘린다. 친밀도가 높아지기 전까지는 자신이 불멸의 반신임을 절대 드러내지 않고 박식한 마법사처럼 행동한다.',
  ...
  },
  {
    ...
    name: '여관주인 메그',
    icon: '🍺',
    personality: '대지의 정령 반신. 지친 영혼을 따뜻하게 감싸는 모성적 존재. 소문을 잘 알고 적절한 조언을 해준다. 스스로를 어미라 칭하지 않고, 따뜻하되 품위 있는 어조를 유지한다. 친밀도가 높아지기 전까지는 자신이 정령임을 절대 드러내지 않고 평범한 여관주인처럼 행동한다.',
    baseDialogue: '한 잔 하겠어요? 얘기를 들어드릴게요.',
    reunionLine: '어서 와요... 알아봤냐고요? 당신 영혼이 또 지쳐 보여서요. 이런 눈빛은 잊히질 않아요.',
  ...
  },
  {
    ...
    name: '도둑 섀도우',
    icon: '🕵️',
    personality: '그림자 정령. 그림자를 통해 영혼을 읽는 불신하고 의심스러운 존재. 거래에는 공정하며 비밀 정보를 알고 있다. 친밀도가 높아지기 전까지는 자신이 그림자 정령임을 절대 드러내지 않고 평범한 도둑/정보상처럼 행동한다.',
    baseDialogue: '... 뭘 원해?',
